 ...
 * @author sjkim
 */
public class GradingEssay extends javax.swing.JFrame {
    ...
    /**
     * Creates new form GradingEssay
     */
    public GradingEssay(User userModel,Course courseModel,Activity activityModel,int studentID) {
...
//            java.util.logging.Logger.getLogger(GradingEssay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//        java.awt.EventQueue.invokeLater(new Runnable() {
//            public void run() {
//                new GradingEssay().setVisible(true);
//            }
//        });
//    }
